...
func (testService) ListAnchorEvents(context.Context, string) ([]domain.AnchorEvent, error) {
	return []domain.AnchorEvent{
		{ID: "event-1", AnchorID: "anchor-1", Type: domain.AnchorEventCreated, Confidence: 1},
		{ID: "event-2", AnchorID: "anchor-1", Type: domain.AnchorEventMoved, Reason: "symbol match", Confidence: 0.95},
	}, nil
}

func (testService) StaleQueue(context.Context, string, int) ([]app.StaleEntry, error) {
	return []app.StaleEntry{{Anchor: domain.Anchor{ID: "anchor-1"}, StaleReason: "no match"}}, nil
}

func (testService) RelocationCandidates(context.Context, string) ([]app.RelocationCandidate, error) {
	return []app.RelocationCandidate{{Index: 0, StartLine: 10, EndLine: 12, Confidence: 0.8, Reason: "similar code"}}, nil
}

func (testService) AcceptRelocation(context.Context, app.RelocateInput) (domain.Anchor, error) {
	return domain.Anchor{ID: "anchor-1", Status: domain.AnchorStatusActive}, nil
}
