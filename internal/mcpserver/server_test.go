...
func (fakeService) StaleQueue(context.Context, string, int) ([]app.StaleEntry, error) {
	return []app.StaleEntry{{Anchor: domain.Anchor{ID: "anchor-1"}}}, nil
}

func (fakeService) RelocationCandidates(context.Context, string) ([]app.RelocationCandidate, error) {
	return []app.RelocationCandidate{{Index: 0, StartLine: 10, EndLine: 12, Confidence: 0.8}}, nil
}

func (fakeService) AcceptRelocation(context.Context, app.RelocateInput) (domain.Anchor, error) {
	return domain.Anchor{ID: "anchor-1", Status: domain.AnchorStatusActive}, nil
}

func (fakeService) ListAnchorEvents(context.Context, string) ([]domain.AnchorEvent, error) {
	return []domain.AnchorEvent{{ID: "event-1", AnchorID: "anchor-1", Type: domain.AnchorEventCreated, Confidence: 1}}, nil
}
